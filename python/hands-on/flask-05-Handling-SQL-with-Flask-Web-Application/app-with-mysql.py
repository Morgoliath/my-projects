...
app.config['MYSQL_DATABASE_HOST'] = 'morgo-database.clqqg1sybgkw.us-east-1.rds.amazonaws.com'
...
VALUES 
    ...
    ("Türker", "turker@bethesda.com"),
    ("Hilal", "hilal@apple.com"),
    ("Nermin", "nermin@oxford.com"),
